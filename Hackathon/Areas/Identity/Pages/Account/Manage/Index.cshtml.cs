...
namespace Hackathon.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(HackathonUser user)
        {
            var hackathonUser = await _userManager.FindByIdAsync(user.Id);
            ...
            Input = new InputModel
            {
                ...
                Name = hackathonUser.Name,
                SecondName = hackathonUser.SecondName
            };
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // Check if Name or SecondName has changed
            if (Input.Name != hackathonUser.Name)
            {
                user.Name = Input.Name;
            }

            if (Input.SecondName != hackathonUser.Name)
            {
